...
#ifndef VCCC_STATISTICAL_HPP
#define VCCC_STATISTICAL_HPP
...
template<typename InputIterator,
    VCCC_REQUIRE(vc::iterable<InputIterator>)>
...
template<typename ...Numbers,
    VCCC_REQUIRE(vc::are_arithmetic_v<Numbers...>)>
...
template<typename ...Args,
    VCCC_REQUIRE(!vc::iterable<Args...> && !vc::are_arithmetic_v<Args...>)>
