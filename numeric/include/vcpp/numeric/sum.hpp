...
#ifndef VCPP_NUMERIC_SUM_HPP
#define VCPP_NUMERIC_SUM_HPP
...
template<typename InputIterator, typename UnaryOperation, VCPP_REQUIRE(vc::iterable<InputIterator>)>
 ...
 * sum of args
 */
template<typename ...Args, VCPP_REQUIRE(!vc::iterable<Args...>)>
...
template<typename InputIterator, VCPP_REQUIRE(vc::iterable<InputIterator>)>
...
template<typename Arg1, typename Arg2, VCPP_REQUIRE(!vc::iterable<Arg1> && !vc::iterable<Arg2>)>
constexpr auto square_sum(const Arg1& arg1, const Arg2& arg2){
  return square(arg1) + square(arg2);
}

template<typename Arg, typename ...Args, VCPP_REQUIRE(!vc::iterable<Arg>)>
