...
#ifndef VCPP_TYPE_SUPPORT_VTYPE_CONVERT_HPP
#define VCPP_TYPE_SUPPORT_VTYPE_CONVERT_HPP
...
template<typename NewType, template<typename, int...> class CVType, typename OldType, int ...CVParams,
        VCPP_REQUIRE((!std::is_same<NewType, OldType>::value))>
...
template<typename NewType, template<typename...> class Container, typename OldType, typename ...Params,
        VCPP_REQUIRE((is_container_v<Container<OldType, Params...>>,
...
template<typename NewType, template<typename...> class Container, typename ...Params,
        VCPP_REQUIRE((is_container_v<Container<NewType, Params...>>))>
...
#endif //VCPP_TYPE_SUPPORT_VTYPE_CONVERT_HPP
