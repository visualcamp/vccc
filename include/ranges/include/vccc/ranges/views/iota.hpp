...
@addtogroup ranges
@{
@defgroup ranges_iota__class__Factories ranges::iota_view, views::iota
@brief a \ref ranges::view "view" consisting of a sequence generated by repeatedly incrementing an initial value
@}
 */

/**
@addtogroup ranges_iota__class__Range_factories
@{
A range factory that generates a sequence of elements by repeatedly incrementing an initial value.
Can be either bounded or unbounded (infinite).
...
@sa [std::ranges::iota_view](https://en.cppreference.com/w/cpp/ranges/iota_view)
 */
template<typename W,
...
/// @addtogroup ranges_iota__class__Factories
/// @{
