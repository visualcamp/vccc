...
/// @addtogroup functional_FNV_prime__class basic_FNV_prime
/// @{
...
/// @} functional_FNV_prime__class


/// @addtogroup functional_FNV_offset_basis__class basic_FNV_offset_basis
/// @{
template<typename T, std::size_t Bytes = sizeof(T) * CHAR_BIT>
...
/// @} functional_FNV_offset_basis__class
...
/// @} functional_fnv1__func__fnv1

/// @addtogroup functional_hash_array__func__hash_array hash_array
/// @brief FNV Do hash operation on array
/// @{
template<typename T>
...
/// @} functional_hash_array__func__hash_array
