...
#  */
#
# ifndef VCCC_OPTIONAL_INTERNAL_MOVE_CTOR_H_
# define VCCC_OPTIONAL_INTERNAL_MOVE_CTOR_H_
#
# include <type_traits>
#
# include "vccc/__optional/internal/copy_ctor.h"
...
# endif // VCCC_OPTIONAL_INTERNAL_MOVE_CTOR_H_
