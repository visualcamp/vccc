...
#ifndef VCCC_RANGES_VIEWS_CARTESIAN_PRODUCT_VIEW_HPP
#define VCCC_RANGES_VIEWS_CARTESIAN_PRODUCT_VIEW_HPP
...
constexpr auto cartesian_common_arg_end(R& r) {
  return vccc::ranges::detail::cartesian_common_arg_end_impl(r, common_range<R>{});
}
...
#endif // VCCC_RANGES_VIEWS_CARTESIAN_PRODUCT_VIEW_HPP
