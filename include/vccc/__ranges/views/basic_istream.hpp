...
#ifndef VCCC_RANGES_VIEWS_BASIC_ISTREAM_HPP
#define VCCC_RANGES_VIEWS_BASIC_ISTREAM_HPP
...
template<typename T>
VCCC_INLINE_OR_STATIC constexpr detail::basic_istream_niebloid<T> istream{};
...
#endif // VCCC_RANGES_VIEWS_BASIC_ISTREAM_HPP
