...
#ifndef VCCC_EXPECTED_BAD_EXPECTED_ACCESS_HPP_
#define VCCC_EXPECTED_BAD_EXPECTED_ACCESS_HPP_
...
class bad_expected_access<void> : public std::exception {
 public:
  const char* what() const noexcept override {
    return "vccc::bad_expected_access";
  }
...
#endif // VCCC_EXPECTED_BAD_EXPECTED_ACCESS_HPP_
