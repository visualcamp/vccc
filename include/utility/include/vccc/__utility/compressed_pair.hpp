...
#  */
#
# ifndef VCCC_UTILITY_COMPRESSED_PAIR_HPP
# define VCCC_UTILITY_COMPRESSED_PAIR_HPP
#
# include <cstddef>
# include <type_traits>
# include <utility>
...
VCCC_INLINE_OR_STATIC constexpr compressed_pair_empty_t compressed_pair_empty;
...
template<typename T, typename U> struct tuple_element<0, vccc::compressed_pair<T, U>> { using type = T; };
template<typename T, typename U> struct tuple_element<1, vccc::compressed_pair<T, U>> { using type = U; };
template<typename T, typename U> struct tuple_size<vccc::compressed_pair<T, U>> : std::integral_constant<std::size_t, 2> {};

template<std::size_t I, typename T, typename U>
constexpr tuple_element_t<I, vccc::compressed_pair<T, U>>& get(vccc::compressed_pair<T, U>& p) noexcept {
  return vccc::detail::compressed_pair_getter<I>::get(p);
}
template<std::size_t I, typename T, typename U>
...
template<std::size_t I, typename T, typename U>
constexpr tuple_element_t<I, vccc::compressed_pair<T, U>>&& get(vccc::compressed_pair<T, U>&& p) noexcept {
  return vccc::detail::compressed_pair_getter<I>::get(std::move(p));
}
template<std::size_t I, typename T, typename U>
constexpr const tuple_element_t<I, vccc::compressed_pair<T, U>>&& get(const vccc::compressed_pair<T, U>&& p) noexcept {
  return vccc::detail::compressed_pair_getter<I>::get(std::move(p));
...
template<typename T, typename U> constexpr T& get(vccc::compressed_pair<T, U>& p) noexcept { return p.first(); }
template<typename T, typename U> constexpr const T& get(const vccc::compressed_pair<T, U>& p) noexcept { return p.first(); }
template<typename T, typename U> constexpr T&& get(vccc::compressed_pair<T, U>&& p) noexcept { return std::move(p.first()); }
template<typename T, typename U> constexpr const T&& get(const vccc::compressed_pair<T, U>&& p) noexcept { return std::move(p.first()); }

template<typename T, typename U> constexpr T& get(vccc::compressed_pair<U, T>& p) noexcept { return p.second(); }
template<typename T, typename U> constexpr const T& get(const vccc::compressed_pair<U, T>& p) noexcept { return p.second(); }
template<typename T, typename U> constexpr T&& get(vccc::compressed_pair<U, T>&& p) noexcept { return std::move(p.second()); }
template<typename T, typename U> constexpr const T&& get(const vccc::compressed_pair<U, T>&& p) noexcept { return std::move(p.second()); }
...
#endif // VCCC_UTILITY_COMPRESSED_PAIR_HPP
